...
""", unsafe_allow_html=True)
    ...
    st.markdown("""
<div style="text-align: justify;">
Es un conjunto de cuadros clínicos, signos y síntomas frecuentes en personas adultas mayores, sobre todo después de los 65 años. Estos tienen que ver más con la interacción entre el desgaste causado por el envejecimiento y múltiples patologías que con enfermedades en sí mismas. La consecuencia principal de esto es la reducción progresiva de la capacidad funcional y el deterioro progresivo de la salud, así como el incremento de la polifarmacia. Típicamente los <a href="https://www.insp.mx/avisos/4942-sindromes-geriatricos.html" target="_blank"><strong>síndromes geriátricos</strong></a> tienen una alta prevalencia en la población de personas adultas mayores, y suele acentuarse si coinciden con <a href="https://www.who.int/es/news-room/fact-sheets/detail/noncommunicable-diseases" target="_blank"><strong>enfermedades crónicas</strong></a> o lo padecen personas institucionalizadas. Generan un deterioro progresivo de la autonomía, capacidad funcional e incrementan la necesidad de cuidados específicos. Su aparición puede agravar los daños que ya causan otras comorbilidades y requieren un tratamiento integral (como cuidados <a href="https://www.gob.mx/inapam/articulos/alimentacion-saludable-en-la-edad-avanzada?idiom=es" target="_blank"><strong>nutricionales</strong></a>, <a href="https://www.gob.mx/salud/documentos/atencion-medica-gerontologica" target="_blank"><strong>médicos</strong></a> y <a href="https://www.gob.mx/inapam/articulos/atencion-psicologica-a-personas-adultas-mayores?idiom=es" target="_blank"><strong>psicológicos</strong></a>). Algunos de los síndromes geriátricos más comunes son el <a href="https://www.gob.mx/inapam/articulos/demencia-en-personas-adultas-mayores?idiom=es" target="_blank"><strong>deterioro cognitivo</strong></a>, la <a href="https://www.insp.mx/avisos/4942-sindromes-geriatricos.html" target="_blank"><strong>fragilidad</strong></a> y la <a href="https://www.insp.mx/avisos/5203-sarcopenia-que-es-y-como-prevenirla.html" target="_blank"><strong>sarcopenia</strong></a>.
</div>
""", unsafe_allow_html=True)
