...
##################
    ...
    st.markdown("""En esta sección se calcula el **riesgo de padecer sarcopenia** a partir de las respuestas de las y los participantes de la **Encuesta Nacional Sobre Salud y Envejecimiento** (esta sección analiza los datos de la Edición 2018, puede acceder alas otras ediciones en la barra lateral izquierda). Esto se hace partiendo de la identificación de las preguntas de la encuesta que guarden la mayor similitud posible con las que contiene el cuestionario [**SARC-F**](https://nutricionemocional.es/sites/default/files/tests_frailsarcf_web_2.pdf).
             """) 
    st.markdown("""
