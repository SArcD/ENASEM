...
""", unsafe_allow_html=True)
    ...
    st.markdown("""
<div style="text-align: justify;">
La <a href="https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(19)31138-9/abstract" target="_blank"><strong>sarcopenia</strong></a> es uno de los <a href="https://postgradomedicina.com/sindromes-geriatricos-causas-tratamiento/" target="_blank"><strong>síndromes geriátricos</strong></a> más comunes. Su definición tradicional implica una alteración progresiva y generalizada del músculo esquelético, caracterizada por una pérdida acelerada de masa y función muscular. La incidencia prolongada de sarcopenia en personas adultas mayores puede correlacionarse con la aparición de <a href="https://doi.org/10.1093/gerona/56.3.m146" target="_blank"><strong>deterioro funcional</strong></a>, <a href="https://apps.who.int/iris/handle/10665/43784" target="_blank"><strong>caídas</strong></a>, <a href="https://www.imss.gob.mx/sites/all/statics/guiasclinicas/479GRR_0.pdf" target="_blank"><strong>fragilidad</strong></a> y un aumento en la mortalidad (<a href="https://doi.org/10.1016/j.berh.2022.101754" target="_blank"><strong>Montero-Errasquín & Cruz-Jentoft, 2022</strong></a>). Además, la sarcopenia incrementa la predisposición a <a href="https://doi.org/10.1016/j.arr.2011.03.003" target="_blank"><strong>comorbilidades</strong></a>, añadiendo una capa adicional de complejidad a la gestión de la salud en el contexto geriátrico (<a href="https://doi.org/10.1093/ageing/afy169" target="_blank"><strong>Cruz-Jentoft et al., 2019</strong></a>).
</div>
""", unsafe_allow_html=True)
